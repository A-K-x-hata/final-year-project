...
contract DrugLifecycle {
    ...
    // Mapping from block number to data structures
    ...
    // New mapping to track locked boxes
    ...
    function addQualityControl(uint256 blockNumber, string memory testId, string memory testDate, string memory testTime, string memory testerName, string memory result) public {
        ...
        // Loop through all boxes (1 to 7 in this case) and lock them
    ...
    // New function to lock a box
    // function lockBox(uint256 boxNumber, uint256 blockNumber) public {
    //     lockedBoxes[boxNumber][blockNumber] = true;
    // }
}