window.addEventListener('load', async () => {
  ...
  const contractAddress = "0x8191Da060D9Cf8A2d1d0FC2c8a44129d1A42365d";  // Replace with your contract address
  ...
  document.getElementById('add-product-form').addEventListener('submit', async function (event) {
      ...
      try {
          ...
          // Call addDrug with individual parameters instead of a single object
          ...
          window.location.href = `http://localhost:3005/generate-qr?blockNumber=${blockNumber}`;
