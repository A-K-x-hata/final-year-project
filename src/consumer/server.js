...
app.use(session({
    secret: 'be253547cdb0e674592c6b676250ac8f516d89f951c47d5f1117055ba57acf2c20f379c440c3e7b2fb17b7cdfb5e6febe59c93f36a3fcccb5ca478e306382087', // Replace with your secret key
    resave: false,
...
const razorpay = new Razorpay({
    key_id: 'rzp_test_RePq95eNNSThL6',
    key_secret: 'fAEphJ1wB097sjIXg5srQGlH',
});
...
async function sendOrderConfirmation(orderId) {
    ...
    const pharmacyResult = await pool.query(`
        ...
        FROM pharmacy
        WHERE pharmacy_id = 1`); // Assuming pharmacy_id = 1 is fixed

    // Check if pharmacy email is found
    if (pharmacyResult.rows.length === 0) {
        throw new Error('No pharmacy found for pharmacy_id = 1.');
    }
